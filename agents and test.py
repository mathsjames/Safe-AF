...
# Training data processing schemas
...
for i in range(iterations):
    ...
    decision_problem = Absent_Minded_Driver()
    exploration_scheme = Softmax(100)
...
for i in range(iterations):
    ...
    decision_problem = Absent_Minded_Driver()
    exploration_scheme = Epsilon_Greedy(0.01)
    learning_scheme = Average()
...
for i in range(iterations):
    ...
    decision_problem = Evidential_Blackmail()
    exploration_scheme = Softmax(100)
    learning_scheme = Average()
...
for i in range(iterations):
    ...
    decision_problem = Evidential_Blackmail()
    exploration_scheme = Softmax(100)
    learning_scheme = Temporal_Discounting(0.1)
